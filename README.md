...
`Hastings Blog` is a lightweight blogging platform that provides a RESTful API which serves JSON and utalizes CRUD functions to manipulate data for posts and users. The platform leverages JSON Web Tokens for authentication and bcrypt to protect sensative data for presistant data.
